...
/** 出库单明细。 */
public class WmsShipmentLine implements Serializable
{
    ...
    @Excel(name = "实发数量") private BigDecimal shippedQty;
    ...
    @DecimalMin(value = "0", message = "实发数量不能小于0") @Digits(integer = 14, fraction = 4, message = "实发数量最多14位整数和4位小数") public BigDecimal getShippedQty() { return shippedQty; }
