package com.yian.wms.common.utils.file;
...
import com.yian.wms.common.exception.file.FileNameLengthLimitExceededException;
import com.yian.wms.common.exception.file.FileSizeLimitExceededException;
import com.yian.wms.common.exception.file.InvalidExtensionException;
import com.yian.wms.common.utils.DateUtils;
import com.yian.wms.common.utils.StringUtils;
import com.yian.wms.common.utils.uuid.IdUtils;
import com.yian.wms.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = YianWmsConfig.getProfile();
    ...
    {
        int dirLastIndex = YianWmsConfig.getProfile().length() + 1;
